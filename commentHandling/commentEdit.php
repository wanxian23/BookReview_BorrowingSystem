...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if ($runSQL) {
            ...
            echo "<script>
                    setTimeout(function() {
                        window.location.href = '../commentEdit.php?postCode={$postCode}';
                    }, 3000);
                </script>";            
        }
    } else {
    ...
    <div class="edit-container">
        ...
        <form class="formEdit" action="<?php echo htmlspecialchars("commentEdit.php?commentCode={$userComment['commentCode']}&postCode={$postCode}"); ?>" method="post">
            <p>
