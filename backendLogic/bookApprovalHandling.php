    ...
    <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            if ($resultSqlBorrower && $resultSqlPost) {
                ...
                echo "<label class='statusNote'>Failed To Approve Book Request!</label>";
        ...
        <div class="review-container">
            <div class="review-header">
                <h2 class="review-success"
                    style="text-align: center; font-size: 1.6em;">Book Request Approval Confirmation
                </h2>
            </div>
            ...
            <form id="rejectForm" method="POST" class="confirm-container" action="<?php echo htmlspecialchars("bookApprovalHandling.php?postCode=".$postCode."&borrowerReaderID=".$borrowReaderID); ?>">
                <input type="submit" class="confirm-btn" value="APPROVE">
            </form>
